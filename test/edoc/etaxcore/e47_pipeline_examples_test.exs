defmodule Edoc.Etaxcore.E47PipelineExamplesTest do
  ...
  test "E47001-Odoo.json maps to E47001.json" do
    input = load_input("E47001")
    expected = load_expected("E47001")
    edoc = expected["encabezado"]["idDoc"]["encf"]
    fecha_hora_firma = expected["fechaHoraFirma"]

    actual =
      E47Pipeline.map(input, @company,
        e_doc: edoc,
  ...
  defp example_path(stem, suffix) do
    Path.expand("../../../notes/E47/#{stem}#{suffix}", __DIR__)
  end
