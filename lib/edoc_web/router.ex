defmodule EdocWeb.Router do
  use EdocWeb, :router

  import EdocWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {EdocWeb.Layouts, :root}
  ...
  # scope "/api", EdocWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:edoc, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: EdocWeb.Telemetry
  ...
  scope "/", EdocWeb do
    ...
    live_session :current_user,
      on_mount: [{EdocWeb.UserAuth, :mount_current_scope}] do
