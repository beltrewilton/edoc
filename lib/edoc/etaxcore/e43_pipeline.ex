defmodule Edoc.Etaxcore.E43Pipeline do
  @moduledoc """
  E43 mapper for Odoo invoice payloads.
  """
  ...
  defp item_bieno_servicio_indicator(%{} = item, default) do
    type =
      item
      |> PayloadSupport.value_from_keys(["type", "product_type", "detailed_type"])
      |> string_or_empty()
      |> String.trim()
      |> String.downcase()
  ...
  defp amount_exempt(payload) do
    tax_totals_value(payload, "total_amount") ||
      PayloadSupport.numeric(PayloadSupport.payload_value(payload, "amount_total")) ||
      PayloadSupport.numeric(PayloadSupport.payload_value(payload, "amount_untaxed")) || 0
  end
